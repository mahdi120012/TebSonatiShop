...
class UsersForManager : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState:Bundle?) {
        ...
        rAdapterYouHaveKnow =
            RecyclerAdapter(rModelsYouHaveKnow, "users_for_manager", this, rAdapterYouHaveKnow, "",
        ...
        LoadData.loadUsersForManager(this, rAdapterYouHaveKnow, rModelsYouHaveKnow, rvSefareshat,
